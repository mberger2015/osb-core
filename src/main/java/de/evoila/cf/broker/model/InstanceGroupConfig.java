...
public class InstanceGroupConfig {
    ...
    public InstanceGroupConfig(Integer connections, Integer nodes, String vmType, String persistentDiskType
            , Map<String, Object> properties, List<NetworkReference> networks, List<String> azs) {
